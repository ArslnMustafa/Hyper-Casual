...
public class RidingCylinder : MonoBehaviour
{
    ...
    public void IncerementCylinderVolume(float value)
    {
        _value += value;
        if (_value > 1)
        {
            ...
            //silindir boyutunu tam olarak 1 yap ve 1 den ne kadar büyükse o büyüklükte yeni bir silindir yap
        ...
        else if (_value < 0)
        {
            ...
            //karakterimize bu karakteri yok etmemizi söyleyeceğiz


        }
        else
        {
            //silindirimizin boyutunu güncelleyeceğiz.
            int cylinderCount = PlayerController.Current.cylinders.Count;
